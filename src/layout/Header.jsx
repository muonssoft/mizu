          ...
          >
            <div layout="vertical">
              <div className="header-top">
                <Title level={4}>
                  Configuración
                  <Text className="subtitle">Cambiar color</Text>
                </Title>
              </div>
              ...
              <div className="sidebar-color">
                ...
                <div className="sidebarnav-color mb-2">
                  <Title level={5}>Tipo de navegación </Title>
                  <Text>Escoger una de las dos opciones</Text>
                ...
                <div className="ant-thank">
                  ...
                  <ButtonContainer className="social">
                    <Button type="black">{<InstagramOutlined />}<a style={styles.a} href="https://www.instagram.com/casadoor.co/" target="_blank" rel="noopener noreferrer">Instagram</a></Button>
                    <Button type="black">{<FacebookFilled />}<a style={styles.a} href="https://www.facebook.com/casadoor.co/" target="_blank" rel="noopener noreferrer">Facebook</a></Button>
                  </ButtonContainer>
                </div>
              </div>
            </div>
